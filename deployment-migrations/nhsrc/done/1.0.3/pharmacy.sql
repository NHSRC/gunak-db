...
where checkpoint.name = 'Dispensary services are available in OPD hours' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.14');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Facility ensure access to drug store after OPD hours' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.14');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Generic Drug store is operational 24X7' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.14');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Drugs under NVBDCP' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Drugs under RNTBCP' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Drugs under NLEP' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of ARV Drugs under NACP' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A4.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Drugs for Paediatric HIV management' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A4.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Dispensing of Medicines and consumables for OPD Patients' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A5.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Generic Drug Store' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A5.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Storage of drugs' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A5.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Cold chain management services' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A5.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability departmental signage''s' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Directional signage''s are displayed in hospital for easy access to Pharmacy/Generic drug store' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'List of Drugs available displayed at Pharmacy' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Status of availability of drugs is updated daily' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Timing for dispensing counter of pharmacy are displayed' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'User charges in r/o services are displayed at entrance of generic drug store' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Signage''s and information are available in local language' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of separate Queue for Male and female at dispensing counter' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Pharmacy has easy access for moment of goods' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Behaviour of staff is empathetic and courteous' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Method of Administration /taking of the medicines is informed to patient/ their relative by pharmacist as per doctors prescription in OPD Pharmacy' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B4.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of complaint box and display of process for grievance re addressal and whom to contact is displayed' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Free drugs and consumables for JSSK beneficiaries' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Pharmacy provides generic drug list to all hospital department' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check that patient party has not incurred expenditure on purchasing drugs or consumables from outside.' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Free drugs for BPL patients' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B5.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Local purchase of stock out drugs/ Reimbursement of expenditure to the beneficiaries' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B5.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hospital has allocated space for Pharmacy in OPD' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Dispensary has adequate waiting space as per load' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Pharmacy has patients sitting arrangement as per requirement' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Dispensary counter has provision of shade' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Dedicated area for keeping medical gases' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Dedicated area for keeping inflammables' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Demarcated are of keeping near expiry drugs' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Demarcated area for keeping instruments and consumables' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Dedicated area for cold chain management' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of adequate circulation area for easy moment of staff , drugs and carts' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of functional telephone and Intercom Services' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Adeqauate No of drug dispensing counter as per load' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Unidirectional flow of goods in the Pharmacy .' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Non structural components are properly secured' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Pharmacy does not have temporary connections and loosely hanging wires' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Stabilizer is provided for cold chain room' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Windows of drug store have grills and wire meshwork' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C2.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Floors of the Pharmacy department are non slippery and even' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C2.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Pharmacy has plan for safe storage and handling of potentially flammable materials.' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has sufficient fire exit to permit safe escape to its occupant at time of fire' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check the fire exits are clearly visible and routes to reach exit are clearly marked.' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Pharmacy has installed fire Extinguisher that is Class A , Class B C type or ABC type' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check the expiry date for fire extinguishers are displayed on each extinguisher as well as due date for next refilling is clearly mentioned' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for staff competencies for operating fire extinguisher and what to do in case of fire' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Pharmacist' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C4.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of security staff' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Analgesics/ Antipyretics/Anti inflammatory' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Antibiotics' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Anti Diarrhoeal' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Antiseptic lotion' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Dressing material' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'IV fluids and plasma expenders' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Eye and ENT drops' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Anti allergic' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drugs acting on Digestive system' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drugs acting on cardio vascular system' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drugs acting on central/Peripheral Nervous system' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drugs acting on respiratory system' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drugs acting on uro genital system' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drugs used on Obstetrics and Gynaecology' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hormonal Preparation' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Other drugs and materials' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Vaccine drug and logistics' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Surgical accessories for Eye' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Vitamins and nutritional supplement' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Consumables' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Equipment for maintenance of Cold chain' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of equipments for cleaning' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Storage furniture for drug store' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check parameters for assessing skills and proficiency of clinical staff has been defined' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for competence assessment is done at least once in a year' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Inventory management' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Cold chain management of ILR and deep freezer' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Rational use of drugs' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Prescription Audit' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is skilled for estimation of the requirement and proper storage of the drugs' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.10');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is skilled for maintaining pharmacy records and bin cards' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.10');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'All equipments are covered under AMC including preventive maintenance' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is system of timely corrective break down maintenance of the equipments' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'All the measuring equipments/ instrument are calibrated' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Operating instructions for ILR/ Deep Freezers are available at cold chain room' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drug store has process to consolidate and calculate the consumption of all drugs and consumables' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Forecasting of drugs and consumables is done scientifically based on consumption and disease load' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is trained for forecast the requirement using scientific system' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.1');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Facility has a established procedures for local purchase of drugs in emergency conditions', 205, '', FALSE, TRUE, FALSE, TRUE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.2'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Facility has a established procedures for local purchase of drugs in emergency conditions' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hospital has system for placing requisition to district drug store' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is specified place to store medicines in Pharmacy and drug store' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'All the shelves/racks containing medicines are labelled in pharmacy and drug store' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Product of similar name and different strength are stored separately' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Heavy items are stored at lower shelves/racks' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Fragile items are not stored at the edges of the shelves.' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Sound alike and look alike medicines are stored separately in patient care area and pharmacy' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is separate shelf /rack for storage near expiry drugs' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drug store and pharmacy has system of inventory Management' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.3');
...
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
where checklist.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)')) on conflict on constraint  checkpoint_checklist_id_measurable_element_id_name_inactive_key do update set  sort_order = 215, last_modified_date = current_timestamp, name = 'Drugs and consumables are stored away from water and sources of heat,
...
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drugs and consumables are stored away from water and sources of heat,
direct sunlight etc.' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drugs are not stored at floor and adjacent to wall' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Dispensing counter has system to check the expiry of drugs' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drug store has system to check the expiry of drugs' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drug store has system to inform the patient care areas about near expiry/expired drugs' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is a system of periodic random quality testing of drugs' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Physical verification of inventory is done periodically' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Facility uses bin card system' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'First expiry first out system is established for drugs' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Stores has defined minimum stock for each category of drug as per there consumption pattern' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Reorder level is defined for each category of drugs' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drug store has inventory management software' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drugs are categorized in Vital, Essential and Desirable' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hospital has system to take medicines from store in case of emergency or if required urgently' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check vaccines are kept in sequence' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Work instruction for storage of vaccines are displayed at point of use' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'ILR and deep freezer have functional temperature monitoring devices' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is system in place to maintain temperature chart of ILR' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is system in place to maintain temperature chart of deep freezers' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check thermometer in ILR is in hanging position' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'ILR and deep freezer has functional alarm system' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is aware of Hold over time of cold storage equipments' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Narcotic medicines are kept in double lock' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.8');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Empty ampoules/strips are returned along with narcotic administration detail sheet' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.8');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hospital has system to discard the expired narcotic drugs' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.8');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Facility maintains the list of narcotic and psychotropic drugs available at facility' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.8');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Adequate Illumination at drug store' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Adequate Illumination at dispensing counter' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Temperature control and ventilation in pharmacy' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Security arrangement at pharmacy' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Ask female staff weather they feel secure at work place' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Building is painted/whitewashed in uniform colour' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Interior of patient care areas are plastered & painted' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Floors, walls, roof, roof topes, sinks patient care and circulation areas are Clean' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Surface of furniture and fixtures are clean' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Toilets are clean with functional flush and running water' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for there is no seepage , Cracks, chipping of plaster' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Window panes , doors and other fixtures are intact' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No condemned/Junk material in the Pharmacy and drug store' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No stray animal/rodent/birds' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of power back in Pharmacy' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of power back for cold chain' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'License for storing spirit' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D10.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is aware of their role and responsibilities' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D11.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure to ensure that staff is available on duty as per duty roster' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D11.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is designated in charge for department' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D11.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Pharmacist adhere to their respective dress code' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D11.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure to monitor the quality and adequacy of outsourced services on regular basis' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D12.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drugs are purchased in generic name only' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Facility has essential drug list as per State guideline' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Facility provide list of drugs available to different departments as per essential drug list' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Facility has enabling order from state for writing drugs in generic name only' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is system of conducting periodic prescription audit to ensure that only generic drugs are prescribed' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hospital has its own drug formulary based on EDL' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drug formulary is available with doctors and nurses/ clinical table' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hospital has system to review the drug formulary as per EDL at defined intervals' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hospital has system to review the prescription as per drug formulary and STG' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Pharmacy has list of high risk drugs are available' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Standard Formats available' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Pharmacy records are labeled and indexed' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Records are maintained for Pharmacy' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Pharmacy has adequate facility for storage of records' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is aware of disaster plan' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Role and responsibilities of staff in disaster is defined' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure for immunization of the staff' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F1.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Periodic medical checkups of the staff' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F1.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for Pharmacist are aware of Hospital Antibiotic Policy' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F1.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of cleaning agent as per requirement' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of colour coded bins at point of waste generation' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of colour coded non chlorinated plastic bags' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Segregation of expired or discarded drugs in Yellow Bin' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is no mixing of infectious and general waste' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Disposal of expired drugs as per state guidelines' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is a designated departmental nodal person for coordinating Quality Assurance activities' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient satisfaction survey done on monthly basis' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Physical verification of the inventory by Pharmacist/hospital manager at periodic intervals' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Periodic and random sampling of the drugs for Quality Assurance' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Departmental checklist are used for monitoring and quality assurance' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Standard operating procedure for department has been prepared and approved' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Current version of SOP are available with process owner' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for indent the drugs and items from district drug warehouse' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for local purchase of drugs/ generic drug stores' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for reception of drugs and items' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for storage of drugs' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for disposal of expired drugs' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for dispensing of medicines at Pharmacy' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure of indenting the drugs to patient care area' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for issue of the drugs in emergency condition' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for maintenance of temperature of ILR/Deep freezer /refrigerators' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for maintaining near expiry drugs at store and pharmacy' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for rational use of drugs and prescription audit' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for storage of narcotic and psychotropic drugs' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented system for periodic random check and quality testing of drugs' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check staff is a aware of relevant part of SOPs' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Work instruction/clinical protocols are displayed' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Process mapping of critical processes done' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Non value adding activities are identified' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Processes are rearranged as per requirement' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Internal assessment is done at periodic interval' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Pharmacy department co ordinate the prescription audit' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Storage and compilation of records of prescription audit' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Non Compliance are enumerated and recorded' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Action plan prepared' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Corrective and preventive action taken' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check if SMART Quality Objectives have framed' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G7.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check of staff is aware of Mission , Values, Quality Policy and objectives' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G7.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check time bound action plan is being reviewed at regular time interval' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G7.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Basic quality improvement method' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G8.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Advance quality improvement method' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G8.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = '7 basic tools of Quality' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G8.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check periodic assessment of medication and patient care safety risk is done using defined checklist periodically' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G10.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Percentage of drugs available against essential drug list for OPD' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Percentage of drugs available against essential drug list for IPD' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Expenditure on drugs procured throughlocal purchase for BPL patient' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Number of stock out situations in Vital category medicines' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Turn Around time for dispensing medicine at Pharmacy' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = '% of drugs expired during the months' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Proportion of prescription found prescribing non generic drugs' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No of advere drug reaction per thosuand patients' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Antibiotic rate' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Percentage of irrational use of drugs/overprescription' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Waiting time for Pharmacy Counter' and c2.name = 'Pharmacy' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H4.1');
