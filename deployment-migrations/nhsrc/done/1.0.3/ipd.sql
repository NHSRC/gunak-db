...
where checkpoint.name = 'Availability of general medicine indoor services' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of isolation ward services' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of general surgery indoor services' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of burn ward indoor services' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of ophthalmology indoor services' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Orthopaedics indoor services' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Psychiatry Indoor services' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.9');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Availability of Indoor Physiotherapy Procedures', 17, '', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.12'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Indoor Physiotherapy Procedures' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.12');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of nursing services 24X7' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.14');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Availability of dialysis services', 20, '', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.15'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of dialysis services' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.15');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of accident & trauma ward' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.16');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Availability of Indoor services for Management', 35, 'Malaria Kalaazar Dengue & Chikunguna AES/Japanese Encephalitis as prevelant locally', FALSE, TRUE, FALSE, TRUE, (select max(m2.id) from measurable_element m2
                join standard s2 on m2.standard_id = s2.id
                join area_of_concern a on s2.area_of_concern_id = a.id
                join checklist_area_of_concern c3 on a.id = c3.area_of_concern_id
                join checklist c2 on c3.checklist_id = c2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Indoor services for Management' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Indoor treatment of TB patients requires hospitalization' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Inpatient Management of severly ill cases' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A4.3');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Inpatient care for cases require hospitilization', 38, '', FALSE, TRUE, FALSE, TRUE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A4.4'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Inpatient care for cases require hospitilization' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A4.4');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Availabily of Opthalmic ward', 39, '', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A4.5'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availabily of Opthalmic ward' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A4.5');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Availbilty of Geriatic ward', 41, '', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A4.7'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availbilty of Geriatic ward' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A4.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of indoor Services as per local prevalent disease' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability departmental signage''s' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Display of layout/floor directory' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Visiting hours and visitor policy are displayed' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'List of services available are displayed' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Entitlement under different national health program' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'List of drugs available are displayed and updated' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Contact details of referral transport / ambulance displayed' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'User charges if any displayed' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Relevant IEC material displayed at wards' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Signage''s and information are available in local language' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Discharge summery is given to the patient' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.8');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Separate male & female wards' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Male and female toilets are demarcated' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Access to toilet should not go through opposite sex patient care area' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Male attendants are not allowed to stay at night in female ward' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is no discrimination with transgender patients' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No unnecessary /non-essential disclosure of a person’s trans status' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Wheel chair or stretcher for easy Access to the ward' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of ramps with railing' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of disable friendly toilet' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of screens / Curtains' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Examination/ Dressing of patient is done in enclosed area' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of complaint box and display of process for grievance redressal and whom to contact is displayed' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No two patients are treated on one bed' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B3.1');
...
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
where checklist.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)')) on conflict on constraint  checkpoint_checklist_id_measurable_element_id_name_inactive_key do update set  sort_order = 92, last_modified_date = current_timestamp, name = 'Partitions separating men and women are robust enough to
...
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Partitions separating men and women are robust enough to
prevent casual overlooking and overhearing' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient Records are kept at secure place beyond access to general staff/visitors' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No information regarding patient identity and details are unnecessary displayed' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Behaviour of staff is empathetic and courteous' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'HIV status of patient is not disclosed except to staff that is directly involved in care' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B3.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'General Consent is taken before admission' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient is informed about clinical condition and treatment been provided' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B4.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of complaint box and display of process for grievance re redressal and whom to contact is displayed' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Stay in wards is free for entitled patients under NHP and state scheme' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drugs and consumables under NHP are free of cost' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check that patient party has not spent on purchasing drugs or consumables from outside.' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check that patient party has not spent on diagnostics from outside.' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'All treatments are free of cost for BPL Patients' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B5.4');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Cashless treatment been provide to smart card holders', 110, '', FALSE, TRUE, FALSE, TRUE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B5.6'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Cashless treatment been provide to smart card holders' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B5.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Declaration is taken from the LAMA patient and the consequences are explained' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B6.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Adequate space in wards with no cluttering of beds' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Functional toilets with running water and flush are available as per strength and patient load of ward' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Functional bathroom with running water are available as per strength and patient load of ward' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of drinking water' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient/ visitor Hand washing area' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Separate toilets for visitors' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'TV for entertainment and health promotion' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Adequate shaded waiting area is provide for attendants of patient' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Dedicated nursing station' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Examination room' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Treatment room' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Doctor''s Duty room' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Nurse Duty room' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Store' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Dirty room' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is sufficient space between two bed to provide bed side nursing care and movement' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Corridors are wide enough for patient, visitor and trolley/ equipment movement' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of functional telephone and Intercom Services' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is separate nursing station for each ward' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of IPD beds as per load' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Surgical wards has functional linkages with OT' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Location of nursing station and patients beds enables easy and direct observation of patients' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Non structural components are properly secured' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'IPD building does not have temporary connections and loosely hanging wires' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Floors of the ward are non slippery and even' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C2.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Windows have grills and wire meshwork' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C2.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Ward has sufficient fire exit to permit safe escape to its occupant at time of fire' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check the fire exits are clearly visible and routes to reach exit are clearly marked.' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'IPD has installed fire Extinguisher that is Class A , Class B, C type or ABC type' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check the expiry date for fire extinguishers are displayed on each extinguisher as well as due date for next refilling is clearly mentioned' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for staff competencies for operating fire extinguisher and what to do in case of fire' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of specialist doctor on call' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of General duty doctor at all time' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Nursing staff' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of dresser in surgical ward' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C4.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of ward attendant/ Ward boy' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability Security staff' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Analgesics/Antipyretics/Anti Inflammatory' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Antibiotics' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Infusion Fluids' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Drugs acting on CVS' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of drugs action on CNS/PNS' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of dressing material and antiseptic lotion' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drugs for Respiratory System' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hormonal Preparation' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Medical gases' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of dressing material in surgical wards' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of syringes and IV Sets /tubes' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Antiseptic Solutions' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of emergency drug tray' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of functional Equipment &Instruments for examination & Monitoring' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of dressing tray for Surgical Ward' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Point of care diagnostic instruments' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of functional Instruments for Resuscitation.' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of equipment for storage for drugs' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of equipments for cleaning' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of equipment for sterilization and disinfection' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of patient beds with prop up facility' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of attachment/ accessories with patient bed' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Fixtures' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of furniture' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check parameters for assessing skills and proficiency of clinical staff has been defined' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for competence assessment is done at least once in a year' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Biomedical waste management' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Infection control and hand hygiene' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient Safety' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Nursing staff is skilled for maintaining clinical records' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.10');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'All equipments are covered under AMC including preventive maintenance' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is system of timely corrective break down maintenance of the equipments' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'All the measuring equipments/ instrument are calibrated' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is established system of timely indenting of consumables and drugs at nursing station' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drugs are stored in containers/tray/crash cart and are labelled' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Empty and filled cylinders are labelled' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Expiry dates'' are maintained at emergency drug tray' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No expiry drug found' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Records for expiry and near expiry drugs are maintained for drug stored at department' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is practice of calculating and maintaining buffer stock' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department maintained stock and expenditure register of drugs and consumables' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure for replenishing drug tray /crash cart' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is no stock out of drugs' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Temperature of refrigerators are kept as per storage requirement and records are maintained' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Narcotic and psychotropic drugs are identified and stored in lock and key' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.8');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Adequate Illumination at nursing station' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Adequate illumination in patient care areas' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Visiting hour are fixed and practiced' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is no overcrowding in the wards during to visitors hours' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'One family members is allowed to stay with the patient' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Temperature control and ventilation in patient care area' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Temperature control and ventilation in nursing station/duty room' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Security arrangement in IPD' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Ask female staff weather they feel secure at work place' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Building is painted/whitewashed in uniform colour' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Interior of patient care areas are plastered & painted' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Floors, walls, roof, roof topes, sinks patient care and circulation areas are Clean' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Surface of furniture and fixtures are clean' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Toilets are clean with functional flush and running water' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for there is no seepage , Cracks, chipping of plaster' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Window panes , doors and other fixtures are intact' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patients beds are intact and painted' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Mattresses are intact and clean' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No condemned/Junk material in the ward' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No stray animal/rodent/birds' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of 24x7 running and potable water' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of power back up in patient care areas' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Nutritional assessment of patient done as required and directed by doctor' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for the adequacy and frequency of diet as per nutritional requirement' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for the Quality of diet provided' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure of requisition of different type of diet from ward to kitchen' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Clean Linens are provided for all occupied bed' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Gown are provided at least to the cases going for surgery' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Blankets, draw sheet, pillow with pillow cover and mackintosh' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Linen is changed every day and whenever it get soiled' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is system to check the cleanliness and Quantity of the linen received from laundry' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is aware of their role and responsibilities' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D11.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure to ensure that staff is available on duty as per duty roster' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D11.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is designated in charge for department' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D11.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Doctor, nursing staff and support staff adhere to their respective dress code' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D11.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure to monitor the quality and adequacy of outsourced services on regular basis' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D12.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Unique identification number is given to each patient during process of registration' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient demographic details are recorded in admission records' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is no delay in admission of patient' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Admission is done by written order of a qualified doctor' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Time of admission is recorded in patient record' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is provision of extra Beds' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E1.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Initial assessment of all admitted patient done as per standard protocols' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient History is taken and recorded' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Physical Examination is done and recorded wherever required' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Provisional Diagnosis is recorded' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Initial assessment and treatment is provided immediately' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Initial assessment is documented preferably within 2 hours' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is fixed schedule for assessment of stable patients' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E2.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'For critical patients admitted in the ward there is provision of reassessment as per need' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E2.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Facility has established procedure for handing over of patients from one department to other department' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is a procedure for consultation of the patient to other specialist with in the hospital' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient referred with referral slip' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Advance communication is done with higher centre' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Referral vehicle is being arranged' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Referral in or referral out register is maintained' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Facility has functional referral linkages to lower facilities' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is a system of follow up of referred patients' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Duty Doctor and nurse is assigned for each patients' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is a process for ensuring the identification before any clinical procedure' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Treatment chart are maintained' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is a process to ensue the accuracy of verbal/telephonic orders' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient hand over is given during the change in the shift' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Nursing Handover register is maintained' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hand over is given bed side' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Nursing notes are maintained adequately' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E4.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient Vitals are monitored and recorded periodically' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Critical patients are monitored continually' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Vulnerable patients are identified and measures are taken to protect them from any harm' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'High risk patients are identified and treatment given on priority' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for BHT if drugs are prescribed under generic name only' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for that relevant Standard treatment guideline are available at point of use' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check staff is aware of the drug regime and doses as per STG' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check BHT that drugs are prescribed as per STG' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of drug formulary' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'High alert drugs available in department are identified' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Maximum dose of high alert drugs are defined and communicated' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is process to ensure that right doses of high alert drugs are only given' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Every Medical advice and procedure is accompanied with date , time and signature' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for the writing, It comprehendible by the clinical staff' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drugs are checked for expiry and other inconsistency before administration' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check single dose vial are not used for more than one dose' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for separate sterile needle is used every time for multiple dose vial' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Any adverse drug reaction is recorded and reported' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Administration of medicines done after ensuring right patient, right drugs , right route, right time' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient is advice by doctor/ Pharmacist /nurse about the dosages and timings .' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Day to day progress of patient is recorded in BHT' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Treatment plan, first orders are written on BHT' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Maintenance of treatment chart/treatment registers' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Any procedure performed written on BHT' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Standard Format for bed head ticket/ Patient case sheet available as per state guidelines' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Registers and records are maintained as per guidelines' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'All register/records are identified and numbered' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Safe keeping of patient records' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Assessment is done before discharging patient' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E9.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Discharge is done by a responsible and qualified doctor' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E9.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient / attendants are consulted before discharge' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E9.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Treating doctor is consulted/ informed before discharge of patients' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E9.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Discharge summary is provided' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E9.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Discharge summary adequately mentions patients clinical condition, treatment given and follow up' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E9.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Discharge summary is give to patients going in LAMA/Referral' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E9.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient is counselled before discharge' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E9.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Time of discharge is communicated to patient in prior' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E9.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is aware of disaster plan' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Role and responsibilities of staff in disaster is defined' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Container is labelled properly after the sample collection' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E12.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Nursing station is provided with the critical value of different tests' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E12.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Consent is taken before transfusion' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E13.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient''s identification is verified before transfusion' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E13.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'blood is kept on optimum temperature before transfusion' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E13.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Blood transfusion is monitored and regulated by qualified person' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E13.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Blood transfusion note is written in patient recorded' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E13.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Any major or minor transfusion reaction is recorded and reported to responsible person' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E13.10');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Pre anaesthesia check up is conducted for elective / Planned surgeries' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E14.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Facility has a standard procedure to decent communication of death to relatives' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E16.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Death note is written on patient record' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E16.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Death summary is given to patient attendant quoting the immediate cause and underlying cause if possible' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E16.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Death note including efforts done for resuscitation is noted in patient record' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E16.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Weekly reporting of Presumptive cases on form ""P"" from IPD' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E23.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure to report cases of Hospital acquired infection' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure for immunization of the staff' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F1.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Periodic medical checkups of the staff' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F1.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Regular monitoring of infection control practices' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F1.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for Doctors are aware of Hospital Antibiotic Policy' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F1.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of hand washing Facility at Point of Use' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of running Water' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of antiseptic soap with soap dish/ liquid antiseptic with dispenser.' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Alcohol based Hand rub' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Display of Hand washing Instruction at Point of Use' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Adherence to 6 steps of Hand washing' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff aware of when to hand wash' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Antiseptic Solutions' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Proper cleaning of procedure site with antisepsis' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Clean gloves are available at point of use' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Masks' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No reuse of disposable gloves, Masks, caps and aprons.' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Compliance to correct method of wearing and removing the gloves' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Decontamination of operating & Procedure surfaces' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Proper Decontamination of instruments after use' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Contact time for decontamination is adequate' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Cleaning of instruments after decontamination' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Proper handling of Soiled and infected linen' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff know how to make chlorine solution' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Equipment and instruments are sterilized after each use as per requirement' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'High level Disinfection of instruments/equipments is done as per protocol' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Autoclaved dressing material is used' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of disinfectant as per requirement' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of cleaning agent as per requirement' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is trained for spill management' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Cleaning of patient care area with detergent solution' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is trained for preparing cleaning solution as per standard procedure' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Standard practice of mopping and scrubbing are followed' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Cleaning equipments like broom are not used in patient care areas' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Isolation and barrier nursing procedure are followed for septic cases' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of colour coded bins at point of waste generation' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of colour coded non chlorinated plastic bags' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Segregation of Anatomical and solied waste in Yellow Bin' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Segregation of infected plastic waste in red bin' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Display of work instructions for segregation and handling of Biomedical waste' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is no mixing of infectious and general waste' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of functional needle cutters' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Seggregation of sharps waste including Metals in white (translucent) Puncture proof, Leak proof, tamper proof containers' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of post exposure prophylaxis' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff knows what to do in condition of needle stick injury' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Contaminated and broken Glass are disposed in puncture proof and leak proof box/ container with Blue colour marking' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check bins are not overfilled' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Transportation of bio medical waste is done in close container/trolley' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is aware of mercury spill management' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is a designated departmental nodal person for coordinating Quality Assurance activities' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient satisfaction survey done on monthly basis' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is system daily round by Hospital superintendent/ Hospital Manager/ Matron in charge for monitoring of services' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Departmental checklist are used for monitoring and quality assurance' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Standard operating procedure for department has been prepared and approved' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Current version of SOP are available with process owner' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for receiving and initial assessment of the patient' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for admission, shifting and referral 0f patient' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for requisition of diagnosis and receiving of the reports' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for preparation of the patient for surgical procedure' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for transfusion of blood' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for maintenance of rights and dignity of Patient' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for record eminence including taking consent' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for counselling of the patient at the time of discharge' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for environmental cleaning and processing of the equipment' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for sorting, and distribution of clean linen to patient' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for end of life care' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check staff is a aware of relevant part of SOPs' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Work instruction/clinical protocols are displayed' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Process mapping of critical processes done' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Non value adding activities are identified' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Processes are rearranged as per requirement' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Internal assessment is done at periodic interval' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure to conduct Medical Audit' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure to conduct Prescription audit' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure to conduct Death audit' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Non Compliance are enumerated and recorded' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Action plan prepared' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check correction & corrective actions are taken' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check if SMART Quality Objectives have framed' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G7.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check of staff is aware of Mission , Values, Quality Policy and objectives' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G7.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check time bound action plan is being reviewed at regular time interval' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G7.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Basic quality improvement method' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G8.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Advance quality improvement method' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G8.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = '7 basic tools of Quality' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G8.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check periodic assessment of medication and patient care safety risk is done using defined checklist periodically' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G10.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Bed Occupancy Rate of Medical Wards' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Bed Occupancy Rate for surgical wards' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Referral Rate' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Bed Turnover rate' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Discharge rate' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No. of drugs stock out in the ward' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Average length of stay for Medical wards' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Average length for surgical wards' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Time taken for initial assessment' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'LAMA Rate' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient Satisfaction Score' and c2.name = 'IPD' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H4.1');
