...
where checkpoint.name = 'Availability of Emergency Medical Procedures' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.1');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Availability of Emergency Surgical Procedures', 5, 'Appendicitis, Intestinal Obstruction, Assault Injuries, perforation, Burns', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                join standard s2 on m2.standard_id = s2.id
                join area_of_concern a on s2.area_of_concern_id = a.id
                join checklist_area_of_concern c3 on a.id = c3.area_of_concern_id
                join checklist c2 on c3.checklist_id = c2.id
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.2'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
where checklist.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)')) on conflict on constraint  checkpoint_checklist_id_measurable_element_id_name_inactive_key do update set  sort_order = 5, last_modified_date = current_timestamp, name = 'Availability of Emergency Surgical Procedures', means_of_verification = 'Appendicitis, Intestinal Obstruction, Assault Injuries, perforation, Burns', am_observation = TRUE, am_staff_interview = TRUE, am_patient_interview = FALSE, am_record_review = FALSE
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Emergency Surgical Procedures' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.2');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Availability of Emergency Obstetrics &Gynaecology Procedures', 6, 'APH, PPH, Eclampsia , Obstructed labour, Septic abortion, Emergency Contraceptives', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.3'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Emergency Obstetrics &Gynaecology Procedures' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of emergency Paediatric procedures' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.4');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Availability of Emergency Ophthalmology procedures', 8, 'Foreign body and injuries', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.5'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Emergency Ophthalmology procedures' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.5');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Availability of Emergency ENT procedures', 9, 'Epitasis, foreign body', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.6'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Emergency ENT procedures' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.6');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Availability of Emergency Orthopaedic procedures', 10, 'Fracture, RTA, Poly trauma', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.7'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Emergency Orthopaedic procedures' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.7');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Availability of Emergency Psychiatric procedures', 12, 'Conversion Reactions, other Psychiatric emergencies Hysteria, mania, psychosis', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.9'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Emergency Psychiatric procedures' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.9');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Availability of Dressing room facility', 16, 'Drainage, dressing, suturing', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.13'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Dressing room facility' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.13');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of injection room facilities' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.13');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = '24X7 availability of dedicated emergency Services' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.14');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Availability of Emergency procedures', 20, 'Defibrillation, CPR, Mobilization, Chest Tube, Intubations, Tracheostomy, Mechanical Ventilation', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                join standard s2 on m2.standard_id = s2.id
                join area_of_concern a on s2.area_of_concern_id = a.id
                join checklist_area_of_concern c3 on a.id = c3.area_of_concern_id
                join checklist c2 on c3.checklist_id = c2.id
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.16'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
where checklist.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)')) on conflict on constraint  checkpoint_checklist_id_measurable_element_id_name_inactive_key do update set  sort_order = 20, last_modified_date = current_timestamp, name = 'Availability of Emergency procedures', means_of_verification = 'Defibrillation, CPR, Mobilization, Chest Tube, Intubations, Tracheostomy, Mechanical Ventilation', am_observation = TRUE, am_staff_interview = TRUE, am_patient_interview = FALSE, am_record_review = FALSE
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Emergency procedures' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A1.16');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Emergency Obstetrics & Gynaecology procedure' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A2.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Triage and emergency management of paediatric cases' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A2.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability / Linkage to X-ray & USG services' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A3.1');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('X-Ray Services are functional 24X7', 31, 'Check services are functional at night', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                join standard s2 on m2.standard_id = s2.id
                join area_of_concern a on s2.area_of_concern_id = a.id
                join checklist_area_of_concern c3 on a.id = c3.area_of_concern_id
                join checklist c2 on c3.checklist_id = c2.id
...
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
where checklist.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)')) on conflict on constraint  checkpoint_checklist_id_measurable_element_id_name_inactive_key do update set  sort_order = 31, last_modified_date = current_timestamp, name = 'X-Ray Services are functional 24X7', means_of_verification = 'Check services are functional at night', am_observation = TRUE, am_staff_interview = TRUE, am_patient_interview = FALSE, am_record_review = FALSE
where checkpoint.name = 'X-Ray Services are functional 24X7' and checkpoint.id = (
  select checkpoint.id from checkpoint
    join checklist c2 on checkpoint.checklist_id = c2.id
    join assessment_tool_checklist a on c2.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'X-Ray Services are functional 24X7' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Emergency diagnostic tests 24x7' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A3.2');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Availability of Functional ECG Services', 33, '', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A3.3'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Functional ECG Services' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A3.3');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Availability of Police post', 50, '', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A5.3'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Police post' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A5.3');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Availability of Medico-legal record services', 54, '', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A5.7'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Medico-legal record services' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A5.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of specific procedures for local prevalent emergencies' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability departmental signage''s .' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Directional Signage''s.' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'List of services including emergencies that are managed at the facility' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Names of doctor and nursing staff on duty are displayed and updated' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'List of drugs available are displayed' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Important numbers including ambulance, blood bank , police and referral centres displayed' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'IEC Material is displayed' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Signage''s and information are available in local language' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.6');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Enquiry services are available 24X7.', 71, 'Enquiry services may be provided by registration clerk/Nurse in a small set up. For large and busy emergency departments there should be dedicated enquiry counter', TRUE, FALSE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.7'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Enquiry services are available 24X7.' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Treatment note/discharge note is given to patient' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.8');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Separate room for examination of rape victims' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of sexual assault forensic evidence kit' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of protocols /guidelines for collection of forensic evidence in case of rape victim' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Counselling services are available for rape victim and domestic violence' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of female staff if a male doctor examine a female patients' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Separate toilets for male and females' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Demarcated male and female observation areas' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Wheel chair/ stretcher for emergency' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of ramps with railing' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Emergency is located at ground floor' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Ambulance has direct access to the receiving/triage area of the emergency.' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of disable friendly toilet' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Screens provided at emergency' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Confidentiality of patient record maintained' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'MLC cases are kept in secure place beyond access of general public' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Behaviour of staff is empathetic and courteous' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Privacy and confidentiality of HIV, Rape, suicidal cases, domestic violence and psychotic cases' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B3.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Consent is taken for invasive emergency procedures' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B4.1');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Display of patient rights and responsibilities.', 97, '', TRUE, FALSE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B4.2'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Display of patient rights and responsibilities.' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B4.2');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Staff is aware about patient rights and responsibilities', 98, '', FALSE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B4.3'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is aware about patient rights and responsibilities' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient is informed about her clinical condition and treatment been provided' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B4.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of complaint box and display of process for grievance redresaal and whom to contact is displayed' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Emergency services are free for all including pregnant woman, neonate and children' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check that patient party has not spent on purchasing drugs or consumables from outside.' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check that patient party has not spent on diagnostics from outside.' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Free Emergency Consultation for BPL patients' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B5.4');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Patients Relatives are informed clearly about the deterioration in health condition of Patients', 114, '', FALSE, TRUE, TRUE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B6.6'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patients Relatives are informed clearly about the deterioration in health condition of Patients' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B6.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is a standard procedure of removal of life sustaining treatment as per law' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B6.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is a procedure to allow patient relative/Next of Kin to observe patient in last hours' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B6.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Declaration is taken from the LAMA patient' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B6.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Adequate space for accommodating emergency load' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of adequate waiting area' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of seating arrangement in the waiting area' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of cold Drinking water' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of functional toilets' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Demarcated trolley bay' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Demarcated receiving /triage areas' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Demarcated Nursing station' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Demarcated duty room for doctor /nurse' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Demarcated resuscitation area' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Demarcated observation area/beds' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Demarcated dressing area /room' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Demarcated injection room' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Demarcated area for keeping serious patient for intensive monitoring' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Demarcated areas for keeping dead bodies.' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Lay out is flexible' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Dedicated Minor OT' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Shaded porch for ambulance' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'availability of clean and dirty utility room' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Corridors at Emergency are broad enough for easy moment of stretcher and trolley' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of functional telephone and Intercom Services' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'The ambulance(s) has a proper communication system(at least cell phone)' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of emergency beds as per load' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of buffer beds for handling mass causality and disaster' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Unidirectional flow of services.' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Separate entrance for emergency department' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Emergency has functional linkage with Major OT , ICU and labour room , Indoors and laboratories' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Emergency is located near to the entry of the hospital' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Non structural components are properly secured' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Emergency department does not have temporary connections and loosely hanging wires' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Floors of the Emergency are non slippery and even' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C2.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Windows have grills and wire meshwork' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C2.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Emergency has sufficient fire exit to permit safe escape to its occupant at time of fire' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check the fire exits are clearly visible and routes to reach exit are clearly marked.' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Emergency has installed fire Extinguisher that is Class A , Class B, C type or ABC type' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check the expiry date for fire extinguishers are displayed on each extinguisher as well as due date for next refilling is clearly mentioned' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for staff competencies for operating fire extinguisher and what to do in case of fire' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of specialist Doctor' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of emergency medical officer' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Nursing staff' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of dresser /paramedic' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C4.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Dedicated 24X7 house keeping staff' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'availability of dedicated security guards 24X7' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of registration clerk' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Drivers for Ambulance 24X7' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Analgesics/Antipyretics/Anti Inflammatory' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Antibiotics' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Infusion Fluids' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Drugs acting on CVS' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of drugs action on CNS/PNS' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of dressing material and antiseptic lotion' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drugs for Respiratory System' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hormonal Preparation' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of emergency drugs in ambulance' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of drugs for obstetric emergencies' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Medical gases' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Immunological' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Antidotes and Other Substances used in Poisonings' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Resuscitation Consumables / Tubes' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of disposables at dressing room' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of consumables in ambulance' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Emergency Drug Tray/ Crash Cart is maintained at emergency' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of functional Equipment &Instruments for examination & Monitoring' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Monitoring equipments in ambulance' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of dressing tray for Emergency procedures' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Dressing tray are in adequate numbers as per load' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of instruments for emergency obstetrics procedure' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of functional Instruments for Resuscitation.' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of resuscitation equipments in ambulance' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of equipment for storage for drugs' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of equipments for cleaning' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of equipment for sterilization and disinfection' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of patient beds with prop up facility and wheels' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of attachment/accessories with patient bed' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of fixtures' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of furniture at emergency' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check parameters for assessing skills and proficiency of clinical staff has been defined' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for competence assessment is done at least once in a year' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Triage and Mass Casualty Management' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Basic life support (BLS)/ Advance life support (ALS)' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Bio Medical waste Management' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Infection control and hand hygiene' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient Safety' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is skilled for emergency procedures' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.10');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is skilled for resuscitation and use defibrillator' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.10');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is skilled for maintaining clinical records' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.10');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'All equipments are covered under AMC including preventive maintenance' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is system of timely corrective break down maintenance of the equipments' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is skilled for trouble shooting in case equipment malfunction' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'All the measuring equipments/ instrument are calibrated' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Operating instructions for critical equipments are available' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is established system of timely indenting of consumables and drugs' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drugs are stored in containers/tray/crash cart and are labelled' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Empty and filled cylinders are labelled' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Expiry dates'' are maintained at emergency drug tray' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No expiry drug found' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Records for expiry and near expiry drugs are maintained for drug stored at department' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is practice of calculating and maintaining buffer stock in Emergency' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department maintained stock and expenditure register of drugs and consumables in Emergency' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is practice of calculating and maintaining buffer stock in ambulance' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department maintained stock and expenditure register of drugs and consumables in ambulance' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure for replenishing drug tray emergency crash cart' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure for replenishing drug tray emergency crash cart in ambulance' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is no stock out of drugs' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Temperature of refrigerators are kept as per storage requirement and records are maintained' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.7');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Narcotics and psychotropic drugs are kept in lock and key', 248, '', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.8'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Narcotics and psychotropic drugs are kept in lock and key' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D2.8');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Adequate illumination at procedure area' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Adequate illumination at receiving and triage area' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Visitors are restricted at resuscitation and procedure area' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Temperature control and ventilation in patient care area' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Temperature control and ventilation in nursing station/duty room' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There are set procedures for handling mass situation and violence in emergency' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hospital has sound security system to manage overcrowding in emergency' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Ask female staff whether they feel secure at work place' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Building is painted/whitewashed in uniform colour' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Interior of patient care areas are plastered & painted' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Floors, walls, roof, roof topes, sinks patient care and circulation areas are Clean' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Surface of furniture and fixtures are clean' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Toilets are clean with functional flush and running water' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for there is no seepage , Cracks, chipping of plaster' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Window panes , doors and other fixtures are intact' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patients beds are intact and painted' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Mattresses are intact and clean' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No condemned/Junk material in the Emergency' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No stray animal/rodent/birds' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of 24x7 running and potable water' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of power back in Emergency' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of UPS' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Emergency light' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Centralized /local piped Oxygen and vacuum supply' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Clean Linens are provided at observation beds' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Linen are changed after change shift of each patient or whenever it get soiled' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is system to check the cleanliness and Quantity of the linen received from laundry' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Valid licences for ambulances are available' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D10.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is aware of requirements of medico legal cases' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D10.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is aware of their role and responsibilities' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D11.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure to ensure that staff is available on duty as per duty roster' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D11.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is designated in charge for department' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D11.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Doctor, nursing staff and support staff adhere to their respective dress code' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D11.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure to monitor the quality and adequacy of outsourced services on regular basis' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D12.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient demographic details are recorded in admission records' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is establish procedure for admission of MLC cases as per prevalent laws' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is establish procedure for prisoners as per prevalent local laws' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Admission is done by written order of a qualified doctor' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is no delay in treatment because of admission process' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Time of admission is recorded in patient record' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is no delay in transfer of patient to respective department once admission is confirmed' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Emergency department is aware of admission criteria to critical care units' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is aware of cases that can not be admitted at the facility due to constraint in scope of services' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'The is provision of extra beds, trolley beds in case of high occupancy or mass casualty' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E1.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Assessment criteria of different kind of medical emergencies is defined and practiced' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Initial assessment and treatment is provided immediately' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Initial assessment is documented preferably within 2 hours' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is fixed schedule for reassessment of patient under observation' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E2.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure for hand over for patient transfer from emergency to IPD /OT' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is a procedure consultation of the patient to other specialist with in the hospital' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient referred with referral slip' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of referral linkages to higher centres.' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Advance communication is done with higher centre' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Referral vehicle is being arranged' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Referral in or referral out register is maintained' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Facility has functional referral linkages to lower facilities' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for if there is any system of follow up' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Doctor and nurse is designated for each patient admitted to emergency ward' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is a process for ensuring the identification before any clinical procedure' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Treatment chart are maintained' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is a process to ensure the accuracy of verbal/telephonic orders' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient hand over is given during the change in the shift' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Nursing Handover register is maintained' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hand over is given bed side' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Nursing notes are maintained adequately' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E4.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient Vitals are monitored and recorded periodically' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Critical patients are monitored continually' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Vulnerable patients are identified and measures are taken to protect them from any harm' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'High risk medical emergencies are identified and treatment given on priority' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for BHT if drugs are prescribed under generic name only' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for that relevant Standard treatment guideline are available at point of use' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check staff is aware of the drug regime and doses as per STG' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check BHT that drugs are prescribed as per STG' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of drug formulary at emergency' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'High alert drugs available in department are identified' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Maximum dose of high alert drugs are defined and communicated' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is process to ensure that right doses of high alert drugs are only given' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Every Medical advice and procedure is accompanied with date , time and signature' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for the writing, It comprehendible by the clinical staff' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Drugs are checked for expiry and other inconsistency before administration' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check single dose vial are not used for more than one dose' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for separate sterile needle is used every time for multiple dose vial' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Any adverse drug reaction is recorded and reported' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Administration of medicines done after ensuring right patient, right drugs , right route, right time' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient is advice by doctor/ Pharmacist /nurse about the dosages and timings .' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E7.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Assessment findings are written on BHT' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Treatment plan, first orders are written on BHT' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Maintenance of treatment chart/treatment registers' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Any procedure performed written on BHT' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of form formats for emergency' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Emergency Records are maintained' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'All register/records are identified and numbered' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Safe keeping of MLC records' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Assessment is done before discharging patient from emergency' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E9.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Discharge is done by a responsible and qualified doctor' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E9.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient / attendants are consulted before discharge' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E9.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Treating doctor is consulted/ informed before discharge of patients' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E9.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Discharge summary is provided' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E9.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Discharge summary adequately mentions patients clinical condition, treatment given and follow up' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E9.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Discharge summary is give to patients going in LAMA/Referral' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E9.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Counselling services are provided wherever it is required' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E9.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Emergency has a implemented system of sorting the patients' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Triage area is marked' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Triage protocols are displayed' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Responsibility of receiving and shifting the patient from vehicle is defined' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.1');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Emergency protocols are available at point of use', 393, 'See for protocols of head injury, snake bite, poisoning, drawing etc.', TRUE, FALSE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.2'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Emergency protocols are available at point of use' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is aware of Clinical protocols' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure for CPR' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Lines of authority is defined' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Procedure for internal communication defined' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure for setting up control room' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Disaster buffer stock of medicines and other supplies maintained' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Role and responsibilities of staff in disaster is defined' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is aware of disaster plan' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for how ambulances are called and patient is shifted' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Ambulances are equipped' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'If the patient is stable then he is transferred in ambulance with the trained driver and one staff from hospital.' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'If the patient is serious (as decided by the Doctor), then trained driver and one paramedical staff is mandatory to accompany him.' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'The Patient’s rights are respected during transport.' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Ambulance appropriately equipped for BLS with trained personnel' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is a daily checklist of all equipment and emergency medications' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Ambulance has a log book for the maintenance of vehicle and daily vehicle checklist' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Transfer register is maintained to record the detail of the referred patient' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Medico legal cases are identified by on patient records' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'MLC cases are not delayed because of police proceedings' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure for informing police' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Emergency has criteria for defining medico legal cases' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Container is labelled properly after the sample collection' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E12.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Nursing station is provided with the critical value of different tests' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E12.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is a procedure for issuing the blood promptly for life saving measures' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E13.8');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Consent is taken before transfusion' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E13.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient''s identification is verified before transfusion' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E13.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Blood is kept on optimum temperature before transfusion' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E13.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Blood transfusion is monitored and regulated by qualified person' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E13.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Blood transfusion note is written in patient record' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E13.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Any major or minor transfusion reaction is recorded and reported to responsible person' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E13.10');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('There is procedure for emergency surgeries', 439, 'See surgeon is available on call/on duty', FALSE, TRUE, FALSE, TRUE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E15.1'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure for emergency surgeries' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E15.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Procedure for arranging logistics' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E15.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Facility has a standard procedure to decent communicate death to relatives' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E16.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Death note is written on patient record' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E16.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Past history and sign of any medico legal cause is looked for' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E16.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is criteria for declaring death' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E16.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Procedure for handing over the dead body' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E16.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Death certificate is issued' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E16.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Surface and environment samples are taken for microbiological surveillance' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F1.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure for immunization of the staff' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F1.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Periodic medical checkups of the staff' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F1.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Regular monitoring of infection control practices' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F1.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for Doctors are aware of Hospital Antibiotic Policy' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F1.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of hand washing Facility at Point of Use' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of running Water' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of antiseptic soap with soap dish/ liquid antiseptic with dispenser.' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Alchol based Hand rub' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Display of Hand washing Instruction at Point of Use' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Adherence to 6 steps of Hand washing' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff aware of when to hand wash' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Antiseptic Solutions' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Proper cleaning of procedure site with antisepesis' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Clean gloves are available at point of use' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Masks' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Personal protective kit for infectious patients' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No reuse of disposable gloves, Masks, caps and aprons.' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Compliance to correct method of wearing and removing the gloves' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Decontamination of operating & Procedure surfaces' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Decontamination of instruments after use' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Contact time for decontamination is adeqaute' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Cleaning of instruments after decontamination' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Proper handling of Soiled and infected linen' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff know how to make chlorine solution' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Equipment and instruments are sterlized after each use as per requirement' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'High level Disinfection of instruments/equipments is done as per protocol' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Chemical sterilization of instruments/equipments is done as per protocols' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Autoclaved dressing material is used' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Facility layout ensures separation of general traffic from patient traffic' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of disinfectant as per requirement' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of cleaning agent as per requirement' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is trained for spill management' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Cleaning of patient care area with disinfectant detergent solution' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is trained for preparing cleaning solution as per standard procedure' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Standard practice of mopping and scrubbing are followed' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Cleaning equipments like broom are not used in patient care areas' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Emergency department define list of infectious diseases require special precaution and barrier nursing' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is trained for barrier nursing' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of colour coded bins at point of waste generation' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of colour coded non chlorinated plastic bags' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Segregation of Anatomical and solied waste in Yellow Bin' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Segregation of infected plastic waste in red bin' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Display of work instructions for segregation and handling of Biomedical waste' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is no mixing of infectious and general waste' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of functional needle cutters' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Seggregation of sharps waste including Metals in white (translucent) Puncture proof, Leak proof, tamper proof containers' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of post exposure prophylaxis' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff knows what to do in condition of needle stick injury' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Contaminated and broken Glass are disposed in puncture proof and leak proof box/ container with Blue colour marking' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check bins are not overfilled' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Disinfection of liquid waste before disposal' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Transportation of bio medical waste is done in close container/trolley' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is aware of mercury spill management' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is a designated departmental nodal person for coordinating Quality Assurance activities' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is system daily round by matron/hospital manager/ hospital superitendant/ Hospital Manager/ Matron in charge for monitoring of services' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is system for periodic check up of Ambulances by designated hospital staff' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is periodic assessment of preparedness for disaster by competent authority' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Departmental checklist are used for monitoring and quality assurance' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Standard operating procedure for department has been prepared and approved' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Current version of SOP are available with process owner' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Emergency has documented procedure for receiving the patient in emergency' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for triaging' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for taking consent' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for initial screening of patient' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for nursing care' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for admission and transfer of the patient to ward' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Emergency has documented procedure for Handling medical records' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for maintaining records in Emergency' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure to handle brought in dead patient' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for storage, handling and release of dead body' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for storage and replenishing the medicine in emergency' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for equipment preventive and break down maintenance' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department has documented procedure for Disaster management' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check Staff is a aware of relevant part of SOPs' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Work instruction/clinical protocols are displayed' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Process mapping of critical processes done' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Non value adding activities are identified' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Processes are rearranged as per requirement' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Internal assessment is done at periodic interval' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure to conduct Medical Audit' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure to conduct Prescription audit' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure to conduct Death audit' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Non Compliance are enumerated and recorded' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Action plan prepared' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Corrective and preventive action taken' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check if SMART Quality Objectives have framed' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G7.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check of staff is aware of Mission , Values, Quality Policy and objectives' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G7.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check time bound action plan is being reviewed at regular time interval' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G7.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Basic quality improvement method' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G8.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Advance quality improvement method' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G8.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = '7 basic tools of Quality' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G8.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check periodic assessment of medication and patient care safety risk is done using defined checklist periodically' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G10.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No of Emergency cases per thousand population' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No of trips per ambulance' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No. of trauma cases treated per 1000 emergency cases' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No. of poisoning cases treated per 1000 emergency cases' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No. of cardiac cases treated per 1000 emergency cases' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No. of obstetric cases treated per 1000 emergency cases' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No of resuscitation done per thousand population' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Proportion of Patients attended in Night' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Proportion of BPL Patients' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Response time for ambulance' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Proportion of cases referred' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Response time at emergency for initial assessment' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Average Turn Around Time' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H2.1');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Proportion of patient referred by state owned/108 ambulance per 1000 referral cases', 668, '', FALSE, FALSE, FALSE, TRUE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H2.2'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Proportion of patient referred by state owned/108 ambulance per 1000 referral cases' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H2.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No of adverse events per thousand patients' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Death Rate' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'LAMA Rate' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Absconding rate' and c2.name = 'Emergency' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H4.1');
