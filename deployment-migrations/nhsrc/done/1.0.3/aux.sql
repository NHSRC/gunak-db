...
where checkpoint.name = 'Availability of operational Kitchen' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A5.1');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Availability of functional laundry', 47, 'Arrangement of laundry services inhouse or outsourced', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A5.2'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of functional laundry' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of functional security services 24 X7' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A5.3');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Availability of Housekeeping services 24X7', 49, '', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A5.4'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Housekeeping services 24X7' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A5.4');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Availability of waste disposal services', 50, 'Arrangement for disposal of Bio medical and general waste Inhouse or outsouced', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A5.5'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of waste disposal services' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A5.5');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Availability of maintenance services 24X7', 51, 'Includes Physical infrastructure maintenance and equipment maintenance', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A5.6'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of maintenance services 24X7' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A5.6');
insert into checkpoint (name, sort_order, means_of_verification, am_observation, am_staff_interview, am_patient_interview, am_record_review, measurable_element_id, checklist_id) values ('Availability of Medical record department', 53, '', TRUE, TRUE, FALSE, FALSE, (select max(m2.id) from measurable_element m2
                ...
                join assessment_tool_checklist c4 on c2.id = c4.checklist_id
                join assessment_tool a2 on c4.assessment_tool_id = a2.id
where a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A5.8'), (select checklist.id from checklist
join assessment_tool_checklist a on checklist.id = a.checklist_id
join assessment_tool a2 on a.assessment_tool_id = a2.id
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Medical record department' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'A5.8');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of departmental signage for support service department' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Signage''s and information are available in local language' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Medical records are provided to patient/ Next to kin on request' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B1.8');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'MRD has system to maintain Confidentiality of patient records' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Behaviour of staff is empathetic and courteous' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of complaint box and display of process for grievance re addressal and whom to contact is displayed' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of free diet' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Free diet for BPL patients and JSSK beneficiaries' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'B5.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Dietary Department has adequate space as per requirement' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Laundry Department has adequate space as per requirement' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Medical record Department has adequate space as per requirement' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check Dietary department has demarcated and dedicated area for various activities' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check laundry department has demarcated and dedicated area for its various activities' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of complaint box and display of process for grievance redressal and whom to contact is displayed' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of adequate circulation area for easy moment of staff , goods and food trolley in dietary department' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of adequate circulation area for easy moment of staff, equipments and carts in laundry' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of adequate circulation area in MRD' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'All support services department are connected with intercom' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Unidirectional flow of goods and services in dietary services' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Unidirectional flow of goods and services in laundry services' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C1.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Non structural components are properly secured' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Support services departments does not have temporary connections and loosely hanging wires' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Equipments in wet areas like Laundry and Kitchen are equipped with ground fault protection and designed for wet conditions' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C2.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Floors of the Support services are non slippery and even' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C2.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Building has sufficient fire exit to permit safe escape to its occupant at time of fire' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check the fire exits are clearly visible and routes to reach exit are clearly marked.' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Dietary Department has plan for safe storage and handling of potentially flammable materials.' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Support services has installed fire Extinguisher that is Class A , Class B C type or ABC type are installed in adeqaute number at every strategic points' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check the expiry date for fire extinguishers are displayed on each extinguisher as well as due date for next refilling is clearly mentioned' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for staff competencies for operating fire extinguisher and what to do in case of fire' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Dietician' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C4.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of MRD technician' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C4.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of washer man' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Cook' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Data Entry operator for MRD' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of consumables at dietary department' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of consumables at laundry department' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of equipment for storage for drugs' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Equipments & utensils for Dietary department' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Equipments for Laundry' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Equipments for Medical record department' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of equipments for cleaning' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of furniture and fixtures for Dietary department' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of furniture and fixtures for laundry department' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of furniture and fixtures for Medical record department' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C6.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Bio Medical waste Management' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Infection Control Management' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Training on Medical record Management' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.9');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'MRD Staff is skilled for indexing and storage of Medical records' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.10');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Laundry staff is skilled for segregating and processing of soiled and infectious linen' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'C7.10');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'All equipments are covered under AMC including preventive maintenance' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is system of timely corrective break down maintenance of the equipments' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Up to date instructions for operation and maintenance of equipments are readily available with staff.' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D1.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Adequate Illumination at Kitchen' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Adequate Illumination at Laundry' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Adequate Illumination at Medical record department' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hospital ensures unauthorised entry into dietary department is not permitted' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hospital ensures unauthorised entry into Laundry department is not permitted' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hospital ensures unauthorised entry into Medical record department is not permitted' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Temperature control and ventilation in dietary department' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Temperature control and ventilation in Laundry' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Temperature control and ventilation in Medical record Department' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Ask female staff weather they feel secure at work place' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D3.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Building is painted/whitewashed in uniform colour' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Interior of patient care areas are plastered & painted' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Floors, walls, roof, roof topes, sinks patient care and circulation areas are Clean' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Surface of furniture and fixtures are clean' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Toilets are clean with functional flush and running water' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check for there is no seepage , Cracks, chipping of plaster' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Window panes , doors and other fixtures are intact' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No condemned/Junk material in the Diet department' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No condemned/Junk material in the Laundry' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No condemned/Junk material in the MRD' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No stray animal/rodent/birds/pests' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D4.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of 24x7 running and potable water' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of power back up' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hospital has defined diet schedule for the patients.' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hospital has Special diet schedule for the critical ill patients suffering from Heart Disease, Hypertension, Diabetes, Pregnant Women, diarrhoea and renal patients' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Dietary department has system to calculate the number of diets to be prepared' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Dietary department has procedure for procurement of perishable and non perishable items' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Perishable items are stored in the cold room or refrigerators.' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Non perishable items are kept in racks/ storage container, in ventilated and rodent proof room' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Food is prepared by trained staff, ensuring standards practices' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is a procedure for the distribution of the diet' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Distribution of the food is done in covered food trolleys' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Dietary department has system to check the quality of food provided to patient' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Dietary department has procedure to collect and dispose of kitchen garbage at defined interval and place' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is practice of calculating and maintaining buffer stock in Kitchen' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Department maintained stock and expenditure register in Kitchen' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is system to replenish raw food material' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hospital has sufficient set of linen available per bed' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hospital/ department has inventory of total linen available with category wise distribution in every area' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Linen department has system for Periodic physical verification of linen inventory' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Linen department has separate trolley for distribution of clean linen and collection of dirty linen' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Linen are transported into closed leak proof containers /bags' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Infectious and non infectious linen are transported into separate containers / bags' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Linen department has system of sorting of different category of linen before putting in to washing machine' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Linen department has procedure for sluicing of soiled, infected and fouled linen' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Linen department has procedure to keep record of daily load received from each department' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hospital has system/ designated person to check quality of washed linen' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is a fix time for collection for dirty linen and supply of clean linen' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is a system for verifying the quantity of linen received' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure for condemnation of linen' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is system to check pilferage of linen from ward' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D7.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is aware of their role and responsibilities' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D11.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure to ensure that staff is available on duty as per duty roster' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D11.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is designated in charge for Laundry department' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D11.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is designated in charge for Dietary department' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D11.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is designated in charge for MRD department' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D11.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is adhere to their respective dress code' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D11.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure to monitor the quality and adequacy of outsourced services on regular basis' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'D12.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'All register/records are identified and numbered' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Diet Registers are maintained at Kitchen' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Laundry registers are maintained at laundry' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hospital has procedure for collection, Compilation and maintenance of patient''s records after discharge' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Medical record department has system to check for completion of records' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Medical record department has system for ICD coding /indexing the records' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Medical record department has system to generate statistics for clinical use' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Medical record department has system to generate statistics for administrative use' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Medical record department has system for filling and safe storage of records' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Medical record department has procedure for retention/Preservation of records' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Medical record department has procedure for destruction of old records' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Medical records department has system for retrieval of records' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Medical record department has procedure for production of records in Courts of law when summoned' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Medical records are issued to authorized personnel only' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E8.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is aware of disaster plan' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Role and responsibilities of staff in disaster is defined' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'E11.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is procedure for immunization of the staff' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F1.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Periodic medical checkups of the staff' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F1.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Regular monitoring of infection control practices' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F1.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of hand washing Facility in kitchen' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Running Water (Hot and cold)' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of soap with soap dish/ liquid antiseptic with dispenser' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Display of Hand washing Instruction at Point of Use' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Adherence to 6 steps of Hand washing' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff aware of when to hand wash' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F2.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Clean gloves are available for distribution of food' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of apron' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of caps' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of Heavy duty gloves for laundry' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of gum boats for laundry' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No reuse of disposable gloves, caps and aprons.' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Cleaning and decontamination of food preparation surfaces like cutting board' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Cleaning of utensils and food trolleys' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Decontamination of heavily soiled linen' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Cleaning of washing equipments' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Proper cleaning of items used for preparation and cooking of food' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Facility layout ensures separation of routes for clean and dirty items in kitchen' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Facility layout ensures separation of routes for clean and dirty items in laundry' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is trained for spill management' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Cleaning of patient care area with detergent solution' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is trained for preparing cleaning solution as per standard procedure' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Standard practice of mopping and scrubbing are followed' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Cleaning equipments like broom are not used in patient care areas' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Surface & fixtures are visibly clean with no dust or debris' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff is trained for spill management' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Floors are clean' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No stray animals in the facility/ Patient Care areas' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of colour coded bins at point of waste generation' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of colour coded non chlorinated plastic bags' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Segregation of different category of waste as per guidelines' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Display of work instructions for segregation and handling of Biomedical waste' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is no mixing of infectious and general waste' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Availability of post exposure prophylaxis' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Staff knows what to do in condition of needle stick injury' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Disinfection of liquid waste before disposal' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Daily disposal of food waste with general waste' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'F6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is a designated departmental nodal person for coordinating Quality Assurance activities' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hospital has system to take feed back regarding quality of diet' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Hospital has system to take feed back regarding cleanliness of linen provided' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'There is system daily round by matron/hospital manager/ hospital superintendent/ Hospital Manager/ Matron in charge for monitoring of services' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Kitchen is has system of regular external inspection by Municipal/ FDA authorities' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G3.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Departmental checklist are used for monitoring and quality assurance' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G3.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Standard operating procedure for Dietary department has been prepared and approved' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Current version of SOP are available with process owner' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Standard operating procedure for Laundry Department has been prepared and approved' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Standard operating procedure for Medical record Department has been prepared and approved' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Record Department has documented procedure for indexing of the records' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Record Department has documented procedure for receiving, compiling, and maintaining records' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Record Department has documented procedure for issuing of the records' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Record Department has documented procedure for retention of records' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Record department has documented procedure for pest and rodent control' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Diet department has documented procedure for diet schedule' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Diet department has documented procedure for calculation of diet required in wards' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Diet department has documented procedure for procurement of food items' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Diet department has documented procedure for preparation and distribution of food' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Diet department has documented procedure to check the quality of food provided to the patient' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Diet department has documented procedure for disposal of remaining food' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Diet department has documented procedure for cleaning of kitchen and utensils' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Diet department has documented procedure for checkups of kitchen workers at defined intervals' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Linen department has documented procedure for collection, sorting and cleaning of linen' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Linen department has documented procedure for sluicing of the blood/ body fluid stained linen' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Linen department has documented procedure for distribution of linen in all patient care area' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Linen department has documented procedure for physical verification of the linen for cleanliness or torn out' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Linen department has documented procedure for condemnation of linen' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Linen department has documented procedure corrective and preventive maintenance of laundry equipments' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Security department has documented procedure for duty hours' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Security department has documented procedure for control of incoming and outgoing items' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Security department has documented procedure for visiting hours in patient care area' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Security department has documented procedure for fire safety in hospital' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Security department has documented procedure for electrical safety' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Security department has documented procedure for training and drills of security staff' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check staff is a aware of relevant part of SOPs' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Work instruction/clinical protocols are displayed in Dietary Department' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Work instruction/clinical protocols are displayed in Laundry Department' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Work instruction/clinical protocols are displayed in Medical Record Department' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Work instructions are displayed for hospital cleaniness' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G4.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Process mapping of critical processes done' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G5.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Non value adding activities are identified' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G5.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Processes are rearranged as per requirement' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G5.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Internal assessment is done at periodic interval' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Storage and compilation of records medical audit' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Storage and compilation of records death audit' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Non Compliance are enumerated and recorded' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.3');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Action plan prepared' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Corrective and preventive action taken' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G6.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check if SMART Quality Objectives have framed' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G7.4');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check of staff is aware of Mission , Values, Quality Policy and objectives' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G7.5');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check time bound action plan is being reviewed at regular time interval' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G7.7');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Basic quality improvement method' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G8.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Advance quality improvement method' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G8.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = '7 basic tools of Quality' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G8.2');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Check periodic assessment of medication and patient care safety risk is done using defined checklist periodically' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'G10.6');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No of cases for which medical audit done' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'No of cases for which death audit is done' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Linen Index' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Diet Index' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H1.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Proportion of maternal deaths audited' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Proportion of newborn deaths audited' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Cycle for laundry services' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Proportion of special diets' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H2.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Medical Audit Score' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Death Audit Score' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H3.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Waiting time for getting handicap certificate' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Waiting time for getting death certificate' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient feedback on cleanliness of linen' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H4.1');
...
join assessment_tool_mode a3 on a2.assessment_tool_mode_id = a3.id
join measurable_element m2 on checkpoint.measurable_element_id = m2.id
where checkpoint.name = 'Patient feedback on quality of food' and c2.name = 'Auxillary services' and a2.name = 'Taluka Level (Karnataka)' and m2.reference = 'H4.1');
